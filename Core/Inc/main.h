...
#define HW_Reset_Pin GPIO_PIN_4
#define HW_Reset_GPIO_Port GPIOB
#define HW_Button_Pin GPIO_PIN_5
#define HW_Button_GPIO_Port GPIOB
#define HW_Telemetry_dir_Pin GPIO_PIN_6
#define HW_Telemetry_dir_GPIO_Port GPIOB
